...
class FetchInfoRequest implements BuilderInterface
{
    /**
     * @var Data
     */
    ...
    public function build(array $buildSubject)
    {
        ...
        $request = ['order_id' => $payment->getAdditionalInformation('order_id')];
        $clientConfig = [
            'reference_id' => $payment->getAdditionalInformation('reference_id'),
