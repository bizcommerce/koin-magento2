...
use Koin\Payment\Api\Data\RequestExtensionInterface;
use Koin\Payment\Api\Data\RequestInterface;
...
class Request extends AbstractModel implements RequestInterface
{
     ...
     * CMS page cache tag.
     */
    const CACHE_TAG = 'koin_request';

    /**
     * @var string
     */
    protected $_cacheTag = 'koin_request';
     ...
     * @var string
     */
    protected $_eventPrefix = 'koin_request';
    ...
    {
        $this->_init(\Koin\Payment\Model\ResourceModel\Request::class);
    }
