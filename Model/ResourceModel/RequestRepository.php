...
use Koin\Payment\Api\Data\RequestInterfaceFactory;
use Koin\Payment\Api\Data\RequestSearchResultsInterfaceFactory;
use Koin\Payment\Api\RequestRepositoryInterface;
use Koin\Payment\Model\ResourceModel\Request as ResourceRequest;
use Koin\Payment\Model\ResourceModel\Request\CollectionFactory as RequestCollectionFactory;
...
class RequestRepository implements RequestRepositoryInterface
{
    ...
    {
        /** @var \Koin\Payment\Model\Request $request */
    ...
    public function save(
        \Koin\Payment\Api\Data\RequestInterface $request
    ) {
        try {
    ...
    public function getList(
        ...
        $this->extensionAttributesJoinProcessor->process(
            $collection,
            \Koin\Payment\Api\Data\RequestInterface::class
        );
