...
use Koin\Payment\Api\Data\CallbackInterfaceFactory;
use Koin\Payment\Api\Data\CallbackSearchResultsInterfaceFactory;
use Koin\Payment\Api\CallbackRepositoryInterface;
use Koin\Payment\Model\ResourceModel\Callback as ResourceCallback;
use Koin\Payment\Model\ResourceModel\Callback\CollectionFactory as CallbackCollectionFactory;
...
class CallbackRepository implements CallbackRepositoryInterface
{
    ...
    public function save(
        \Koin\Payment\Api\Data\CallbackInterface $callback
    ) {
        try {
    ...
    public function getList(
        ...
        $this->extensionAttributesJoinProcessor->process(
            $collection,
            \Koin\Payment\Api\Data\CallbackInterface::class
        );
